...
/*
 * Sends the sonar data to the client
...
/*
 * Sets the angle of the oar
 * @param vaue the angle
 */
 ...
 * @param isBackward moving backward (true) or forward (false)
 */
